...
riot.tag2('impure-card-large_tab_show-description', '', 'impure-card-large_tab_show-description .hw-markdown h1,[data-is="impure-card-large_tab_show-description"] .hw-markdown h1{ font-weight: bold; font-size: 20px; } impure-card-large_tab_show-description .hw-markdown h2,[data-is="impure-card-large_tab_show-description"] .hw-markdown h2{ font-weight: bold; font-size: 18px; } impure-card-large_tab_show-description .hw-markdown h3,[data-is="impure-card-large_tab_show-description"] .hw-markdown h3{ font-weight: bold; font-size: 16px; } impure-card-large_tab_show-description .hw-markdown h4,[data-is="impure-card-large_tab_show-description"] .hw-markdown h4{ font-weight: bold; font-size: 14px; } impure-card-large_tab_show-description .hw-markdown h5,[data-is="impure-card-large_tab_show-description"] .hw-markdown h5{ font-weight: bold; font-size: 12px; } impure-card-large_tab_show-description .hw-markdown *,[data-is="impure-card-large_tab_show-description"] .hw-markdown *{ font-size: 12px; } impure-card-large_tab_show-description table { border-collapse: collapse; } impure-card-large_tab_show-description td { border: solid 1px; padding: 2px 5px; } impure-card-large_tab_show-description th { border: solid 1px; padding: 2px 5px; background: #eeeeee; } impure-card-large_tab_show-description li { list-style-type: square; margin-left: 22px; }', 'class="hw-markdown"', function(opts) {
     this.on('update', () => {
