...
;;;;;
(defun list-summary-purge-by-angel-impure-span-sql (angel &key from to)
  (sxql:yield
...
(defun list-summary-purge-by-angel-impure-span (angel &key from to)
  (multiple-value-bind (sql vals)
      (list-summary-purge-by-angel-impure-span-sql angel :from from :to to)
    (print (list-summary-purge-by-angel-impure-span-fix-sql sql))
